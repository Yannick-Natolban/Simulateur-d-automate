...
btn_afne = tk.Button(root, text="Définir un AFNε", command=define_afne)
btn_afne.pack(pady=10)
btn_read = tk.Button(root, text="Lire un mot", command=read_word)
...
btn_prune = tk.Button(root, text="Déterminiser", command=determinise)
btn_prune.pack(pady=10)
btn_display_transitions = tk.Button(root, text="Afficher les transitions", command=display_transitions)
btn_display_transitions.pack(pady=10)
